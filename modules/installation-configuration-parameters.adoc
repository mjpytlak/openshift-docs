...
|The port used to log into Prism Central.
|String

|`platform.nutanix.PrismCentral`
|The Prism Central domain name or IP address.
|String

|`platform.nutanix.prismElementUUID`
|The universally unique identifier (UUID) for Prism Element.
|String

|`platform.vsphere.subnetUUID`
|The UUID of the subnet that is linked to the Prism Element that is managing the {product-title} cluster.
|String

|`platform.nutanix.username`
|The username for logging into Prism Central.
|String.
|====
endif::nutanix[]
