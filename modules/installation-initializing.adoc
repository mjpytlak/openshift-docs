...
ifdef::nutanix[]
* Verify that you have met the xref:preparing-to-install-on-nutanix.adoc#preparing-to-install-on-nutanix[networking requirements].
endif::nutanix[]
...
... Select the Prism Element that is to manage the {product-title} cluster.
